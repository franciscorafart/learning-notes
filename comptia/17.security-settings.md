...
- Default policy inblound and outbound traffic as Block or Allow
...
Concerns on ata stored on browser:
- Clearing cache and browsing data options:
     - By default browser keeps history and caches sites visited
     - OIn public PC is better to clear cache automatically or manually
...
## Malware Payloads
Malware claddification by enrty point.
...
3. Secur euse of software (browser) and email clients plus appropiate use of internet access
