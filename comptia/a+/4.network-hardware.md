...
- PoE enabled switch (endspan Power Sourcing Equipment - PSE) => When connecting to a PoE switch, the Switch detects wether the device is PoE-enabled. If so, it supplies current.
