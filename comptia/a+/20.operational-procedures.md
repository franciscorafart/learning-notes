...
- Incident needs involvement of sales and marketing to deal with complatins or refunds

Support team tier to deal with escalation levels
- Tier 0: Self-service => Knowledge base or help bot
- Tier 1: Connects customer to agent for initial diagnosis and possible incident resolutionn
...
- Important to use clear and concise anguage:
...
- Each instance of asset type requires a unique ID => Hardware devices should be tagged with this ID aas barcode or RFID sticker
...
Procurement life cycke => Discrete stages in use of hardware and software:
...
- Disposal => Procedure for sanitizing and disposabl (recycling, donation, selling, destroying)
...
- Shared-use assetts can be allocated to individual technicians or security groups => Better practice than default administrator accounts.
...
- Knowledge Base (KB) => Repository of articles for FAQ for common torubleshooting scenarios
...
- Change management: Policie and procedures that reduce risk of configuration changes that lead to service downtime.

### ITIL Configuration Management Protocol (IT Infrastructure Library)

- Service asetts are things, processes and people who deliver IT service
...
- Two approaches:
    ...
    - Qualitative rsk => identify and evaluate impact and likelihood factors from previous experience and informed opinion
...
- Process of adaptingis hard and people might magnify minor problems
...
- Implementing regulatory complaince as logical controls could be necessary Ex. Splash screen on login to explain users what they can/can't do
...
- Drive the problet to acceptance and resolution => Solve it or escalate.
...
- Repair: Clear instructions on how to package ad return item for repair with ticket-tracking number and reutned-merchandise authorization (RMA)
...
- Deal appropiately with confidential and private materials
    ...
    - On site visitn, keep work are clean and tidy => Leave it as you found it
...
- If customer not getting to the point, restart with closed quesitons
