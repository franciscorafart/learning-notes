...
Overheating will damage components. Odors and smoke always indicate the PSU is overheating. Sometimes burn smell happens when vents are clogged with dust.
...
- Real Time Clock (RTC) keeps the datetime and usually runs on a CR2032 battery.
