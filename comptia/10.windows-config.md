...
- Store apps: Apps installed from the store that run on a Sandbox, to prevent them from making system wide changis and crashing the OS. No admin privileges required.
