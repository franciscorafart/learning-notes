...
- Domain Network: Main difference of three is ability to join a domain network. Not available on Home Edition.
...
- BitLocker: Encrypt all information on a disk drive, protected even when stolen. Not available on Home Edition.
...
- Windows Pro for Workstations supports more maximum RAM and advanced hardware technologies like Persistent System RAM (NVDIMM)
